...
# Below: some tests to use LaTeX formatting for text rendering
################################
###st.title("Streamlit with LaTeX")
# Inline math
###st.write("This is an example of an inline equation: $E=mc^2$")
# Display math
###st.latex(r'\int_{-\infty}^{\infty} e^{-3x^2} \, dx = \sqrt{\pi}')
################################

#st.title(r'$\textsf{\scriptsize Triangular reversible engine cycle of an ideal gas}$')
